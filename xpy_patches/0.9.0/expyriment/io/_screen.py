...
class Screen(Output):
    ...
    def __init__(self, colour, open_gl, window_mode, window_size, window_frame=True):
...
OpenGL will be deactivated!"
        ...
        if not self._open_gl:
            if self._fullscreen:
                ...
                self._surface = pygame.display.set_mode(self._window_size, 0 if window_frame else pygame.NOFRAME)
            ...
            if self._fullscreen:
                ...
                self._surface = pygame.display.set_mode(
                    self._window_size,
                    pygame.DOUBLEBUF | pygame.OPENGL | (0 if window_frame else pygame.NOFRAME))
                pygame.display.set_caption('Expyriment')
